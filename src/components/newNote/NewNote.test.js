...
describe('tests NewNote', () => {
    ...
    test('is placeholder display', async () => {
        ...
        expect(screen.getByPlaceholderText('Type here your note...')).toBeInTheDocument();
    });
    ...
    test("placeholder doesn't when user type at least a char", async () => {
        ...
        expect(screen.queryByPlaceholderText('Type here your note...')).not.toHaveDisplayValue();
    });
